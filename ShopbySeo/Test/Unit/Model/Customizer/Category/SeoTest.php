...
namespace Dotsquares\ShopbySeo\Test\Model\Customizer\Category;
...
class SeoTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var MockObject|\Dotsquares\ShopbySeo\Helper\Data
     */
    protected $helper;

    /**
     * @var MockObject|\Dotsquares\Shopby\Model\Request
     */
    ...
    /**
     * @var MockObject|\Dotsquares\ShopbyBase\Model\Category\Manager
     */
    ...
    {
        $this->urlBuilder = $this->createMock(\Dotsquares\ShopbyBase\Model\UrlBuilder::class);
        $layout = $this->createMock(\Magento\Framework\View\LayoutInterface::class);
        $this->helper = $this->createMock(\Dotsquares\ShopbySeo\Helper\Data::class);
        ...
        $this->categoryManager = $this->createMock(\Dotsquares\ShopbyBase\Model\Category\Manager::class);
    ...
    {
        $this->dsshopbyRequest->expects($this->any())->method('getRequestParams')->willReturn('test');
