...
namespace Dotsquares\ShopbySeo\Test\Unit\Plugin\Shopby\Controller;

use Dotsquares\ShopbySeo\Plugin\Shopby\Controller\Router;
...
class RouterTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $subject = $this->createMock(\Dotsquares\Shopby\Controller\Router::class);
