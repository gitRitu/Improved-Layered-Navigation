...
namespace Dotsquares\ShopbySeo\Test\Unit\Plugin\Adminhtml;

use Dotsquares\ShopbySeo\Plugin\Adminhtml\ConfigPlugin;
...
class ConfigPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBeforeSave($groups, $section, $expected, $isModuleEnable)
    {
        ...
        $moduleHelper = $this->createMock(\Dotsquares\ShopbySeo\Helper\Data::class);
    ...
    public function beforeSaveDataProvider()
    {
        ...
        return [
            [self::GROUPS_TEST_WITHOUT_VALUE, 'dotsquares_shopby_base', self::GROUPS_TEST_WITHOUT_VALUE, false],
            [self::GROUPS_TEST_WITHOUT_VALUE, 'dotsquares_shopby_seo', self::GROUPS_TEST_WITHOUT_VALUE, false],
            [self::GROUPS_TEST_WITH_VALUE, 'dotsquares_shopby_seo', $resultGroup, true]
        ];
    }
}
