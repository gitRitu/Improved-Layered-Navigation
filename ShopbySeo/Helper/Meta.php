...
{
    public const DSSHOPBYSEO_FOLLOW = 'dsshopbyseo_follow';
    ...
    public function __construct(
        Context $context,
        \Dotsquares\Shopby\Helper\Data $dataHelper,
        Registry $registry,
    ...
    private function setRobots()
    {
        ...
        $this->registry->register(self::DSSHOPBYSEO_FOLLOW, $robots);
    }
    ...
    {
        return $this->integrationFactory->get(\Dotsquares\ShopbyBrand\Helper\Data::class, true);
    }
    ...
    private function getIndexTag(array $appliedFiltersSettings)
    {
        ...
        if ($this->request->getParam('p', 0) > 0) {
            $noIndexPagedCategory = $this->scopeConfig->getValue(
                'dotsquares_shopby_seo/robots/noindex_paginated',
        ...
        if ($result) {
            $isNoIndexWithMultiple = $this->scopeConfig->getValue(
                'dotsquares_shopby_seo/robots/noindex_multiple',
                ScopeInterface::SCOPE_STORE
            );
    ...
    {
        return $this->scopeConfig->isSetFlag('dotsquares_shopby_seo/robots/control_robots', ScopeInterface::SCOPE_STORE);
    }
}
