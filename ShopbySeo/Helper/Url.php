...
class Url extends AbstractHelper
{
    ...
    public function __construct(
        ...
        \Dotsquares\ShopbySeo\Helper\UrlParser $urlParser,
        \Dotsquares\ShopbySeo\Helper\Config $config,
    ...
    private function getFilterPositions()
    {
        if ($this->filterPositions === null) {
            $allFilters = $this->coreRegistry->registry(\Dotsquares\Shopby\Model\Layer\FilterList::ALL_FILTERS_KEY);
    ...
    public function getAddSuffixSettingValue()
    {
        return $this->scopeConfig->isSetFlag(
            'dotsquares_shopby_seo/url/add_suffix_shopby',
