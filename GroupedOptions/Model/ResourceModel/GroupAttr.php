...
use Dotsquares\GroupedOptions\Model\GroupAttrOptionFactory;
use Dotsquares\GroupedOptions\Model\GroupAttrValueFactory;
...
class GroupAttr extends AbstractDb
{
    ...
    public function getOptions($item)
    {
        ...
        if ($object) {
            $select = $this->getConnection()->select()->from(
                ['op' => $this->getTable('dotsquares_grouped_options_group_' . $object)],
    ...
    {
        $select = $this->getConnection()->select()->from(
            ['op' => $this->getTable('dotsquares_grouped_options_group_' . $part)],
