...
namespace Dotsquares\GroupedOptions\Plugin\Swatches\Block\LayeredNavigation\RenderLayered;
...
class AddGroupOptions
{
    ...
    private function getOptionViewData(FilterItem $filterItem, GroupAttrInterface $groupAttr): array
    {
        ...
        return [
            ...
            'dotsquares_shopby_count' => $filterItem->getCount(),
            'dotsquares_shopby_filter_item' => $filterItem
        ];
    }
}
