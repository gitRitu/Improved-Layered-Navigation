...
class AllowedRoute
{
    ...
    public function __construct(
        ...
        \Dotsquares\ShopbyBase\Model\ConfigProvider $configProvider
    ) {
    ...
    {
        return $this->scopeConfig->getValue('dsshopby_brand/general/attribute_code', ScopeInterface::SCOPE_STORE);
    }
}
