...
{
    public const CACHE_TAG = 'dsshopby_option_setting_v';
    public const IMAGES_DIR = '/dotsquares/shopby/option_images/';
    public const SLIDER_DIR = 'slider/';

    /**
     * @var string
     */
    protected $_eventPrefix = 'dsshopby_option_setting';
    ...
    {
        $this->_init(\Dotsquares\ShopbyBase\Model\ResourceModel\OptionSetting::class);
    }
    ...
    public function getUrlPath()
    {
        ...
        return $this->url->getUrl('dsshopby/index/index', [
     ...
     *
     * @param \Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface $model
     * @param \Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface $defaultModel
     * @param array $data
     * @param bool $isSlider
