...
use Dotsquares\Shopby\Model\Layer\GetSelectedFiltersSettings as SelectedFiltersSettings;
...
class IsAddNofollow
{
    ...
    {
        return strpos((string) $this->registry->registry(Meta::DSSHOPBYSEO_FOLLOW), 'nofollow') !== false;
    }
