    ...
    return function (config) {
        ...
        var addButtonsFunction = function () {
            $('#' + id + ' td.col-delete').each(function () {
                if (!$(this).find('.dsshopby-button-option').length) {
                    ...
                    $(this).prepend('<button id="settings_button_' + optionId
                        + '" class="dsshopby-button-option action-settings" data-option-id="'
            ...
            $('.dsshopby-button-option').on('click', function (e) {
                var $button = $(this),
                ...
                $(modalListSettings).parents('.modal-inner-wrap').addClass('ds-popup');
