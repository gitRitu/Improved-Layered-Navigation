...
use Dotsquares\ShopbyBase\Test\Unit\Traits\ObjectManagerTrait;
use Dotsquares\ShopbyBase\Test\Unit\Traits\ReflectionTrait;
...
class FilterSettingTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $layerFilter = $this->getObjectManager()->getObject(\Dotsquares\Shopby\Model\Layer\Filter\Attribute::class);
