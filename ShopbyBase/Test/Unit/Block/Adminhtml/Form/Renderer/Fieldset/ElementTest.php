...
namespace Dotsquares\ShopbyBase\Test\Unit\Block\Adminhtml\Form\Renderer\Fieldset;
...
class ElementTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->dataObject = $this->getObjectManager()->getObject(\Dotsquares\ShopbyBase\Model\OptionSetting::class);
