...
namespace Dotsquares\ShopbyBase\Test\Unit\Block\Widget\Form\Element;
...
class DependenceTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Dotsquares\ShopbyBase\Model\Source\DisplayMode|MockObject
     */
    ...
    {
        $this->displayModeSource = $this->createMock(\Dotsquares\ShopbyBase\Model\Source\DisplayMode::class);
