...
namespace Dotsquares\ShopbyBase\Block\Widget\Form\Element;
...
{
    /**
     * @var \Dotsquares\ShopbyBase\Model\Source\DisplayMode
     */
    ...
    public function __construct(
        ...
        \Dotsquares\ShopbyBase\Model\Source\DisplayMode $displayModeSource,
        array $data = []
    ) {
    ...
    protected function _toHtml()
    {
        ...
        return '<script>
            require(["Dotsquares_ShopbyBase/js/display-mode"], function() {
                var controller = new DotsquaresFormElementDependenceController(' . $this->getConfig() . ');
            });</script>';
    }
