...
namespace Dotsquares\ShopbyPage\Test\Unit\Controller\Adminhtml\Page;
...
class EditTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute($id, $expected)
    {
        ...
        $pageRepository = $this->createMock(\Dotsquares\ShopbyPage\Model\ResourceModel\PageRepository::class);

        if (!$id) {
            $amPage = $this->createMock(\Dotsquares\ShopbyPage\Model\Data\Page::class);
