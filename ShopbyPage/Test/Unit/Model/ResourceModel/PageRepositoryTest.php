...
namespace Dotsquares\ShopbyPage\Test\Unit\Model\ResourceModel;

use Dotsquares\ShopbyPage\Model\ResourceModel\PageRepository;
...
class PageRepositoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $serializer = $this->createMock(\Dotsquares\Base\Model\Serializer::class);
        $pageFactory = $this->createMock(\Dotsquares\ShopbyPage\Model\PageFactory::class);
        $pageResourceModel = $this->createMock(\Dotsquares\ShopbyPage\Model\ResourceModel\Page::class);
