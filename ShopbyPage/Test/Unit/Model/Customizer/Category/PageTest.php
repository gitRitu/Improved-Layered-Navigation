...
namespace Dotsquares\ShopbyPage\Test\Unit\Model\Customizer\Category;

use Dotsquares\ShopbyPage\Api\Data\PageInterface;
use Dotsquares\ShopbyPage\Model\Customizer\Category\Page;
...
class PageTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Dotsquares\ShopbyBase\Helper\FilterSetting
     */
    private $filterSettingHelper;

    public function setUp(): void
    {
        $this->shopbyHelper = $this->createMock(\Dotsquares\Shopby\Helper\Data::class);
        $this->scopeConfig = $this->createMock(\Magento\Framework\App\Config\ScopeConfigInterface::class);
        $this->catalogConfig = $this->createMock(\Magento\Catalog\Model\Config::class);
        $this->dsshopbyRequest = $this->createMock(\Dotsquares\Shopby\Model\Request::class);
        $this->filterSettingHelper = $this->createMock(\Dotsquares\ShopbyBase\Helper\FilterSetting::class);
        ...
        $this->model = $this->getObjectManager()->getObject(
            ...
            [
                ...
                'dsshopbyRequest' => $this->dsshopbyRequest,
    ...
    public function testMatchCurrentFiltersWithFalseResult()
    {
        ...
        $pageData = $this->createMock(\Dotsquares\ShopbyPage\Api\Data\PageInterface::class);
        ...
        $filterSetting = $this->createMock(\Dotsquares\ShopbyBase\Model\FilterSetting::class);
    ...
    public function testIsConditionNotMatchedWithFalse()
    {
        $attribute = $this->createMock(\Magento\Eav\Model\Entity\Attribute\AbstractAttribute::class);
        $this->catalogConfig->expects($this->any())->method('getAttribute')->willReturn($attribute);
        $this->dsshopbyRequest->expects($this->any())->method('getParam')->willReturn('test');
        $attribute->expects($this->any())->method('getId')->willReturn(1);
        $filterSetting = $this->createMock(\Dotsquares\ShopbyBase\Model\FilterSetting::class);
        $filterSetting->expects($this->any())->method('isMultiselect')->willReturn(false);
        $this->filterSettingHelper->expects($this->any())->method('getSettingByAttribute')->with($attribute)
    ...
    {
        $attribute = $this->createMock(\Magento\Eav\Model\Entity\Attribute\AbstractAttribute::class);
        $this->dsshopbyRequest->expects($this->any())->method('getParam')->willReturn('code');
        $this->catalogConfig->expects($this->any())->method('getAttribute')->willReturn($attribute);
        $attribute->expects($this->any())->method('getId')->willReturn(1);
        $filterSetting = $this->createMock(\Dotsquares\ShopbyBase\Model\FilterSetting::class);
    ...
    public function testCheckStrictMatch()
    {
        ...
        $this->dsshopbyRequest->expects($this->any())->method('getParam')->willReturn([]);
