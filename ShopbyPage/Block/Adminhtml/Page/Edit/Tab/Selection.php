...
namespace Dotsquares\ShopbyPage\Block\Adminhtml\Page\Edit\Tab;
...
use Dotsquares\ShopbyPage\Model\Config\Source\Attribute as SourceAttribute;
...
class Selection extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        /** @var \Dotsquares\ShopbyPage\Api\Data\PageInterface $model */
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'    => __('Filter'),
                'title'    => __('Filter'),
                'onchange' => 'window.dotsquaresShopbyPageSelection.add(\'add_selection_fieldset\', this.value); 
                                this.value=0; return;'
            ]
        );
    ...
    public function addSelectionControls(
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'    => __('Filter'),
                'title'    => __('Filter'),
                'onchange' => 'window.dotsquaresShopbyPageSelection.load(\'' .
        ...
        $form->getElement(
            ...
            $this->getLayout()
                ->createBlock(\Dotsquares\ShopbyPage\Block\Adminhtml\Page\Edit\Tab\Selection\Option::class)
        ...
        $fieldset->addField(
            ...
            [
                'value'   => __('Remove'),
                'onclick' => 'window.dotsquaresShopbyPageSelection.remove(\'' . $attributeIdx . '_selection_fieldset\')'
            ]
        );
