...
namespace Dotsquares\ShopbyPage\Block\Adminhtml\Page\Edit\Tab\Selection;
...
class Option extends Widget implements RendererInterface
{
    ...
    public function getValueHtml()
    {
        $block = $this->getLayout()
            ->createBlock(\Dotsquares\ShopbyPage\Block\Adminhtml\Page\Edit\Tab\Selection\Value::class)
