...
use Dotsquares\ShopbyPage\Model\Config\Source\Position as SourcePosition;
...
class Text extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('dotsquares_shopbypage_');
        ...
        $form->setValues(
            $this->extensibleDataObjectConverter->toFlatArray(
                $model,
                [],
                \Dotsquares\ShopbyPage\Api\Data\PageInterface::class
            )
        );
