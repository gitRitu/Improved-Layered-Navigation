...
namespace Dotsquares\ShopbyBrand\Block\Adminhtml\System\Config;
...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    public function getAdditionalModuleContent()
    {
        ...
        if ($this->moduleManager->isEnabled('Magento_GraphQl')
            && !$this->moduleManager->isEnabled('Dotsquares_ShopbyBrandGraphQl')
        ) {
            $message = [
                'type' => 'message-notice',
                'text' => __('Enable shop-by-brand-graphql module to '
                    ...
                    . 'composer require dotsquares/module-shop-by-brand-graphql')
            ];
