...
class BrandsPopup extends \Dotsquares\ShopbyBrand\Block\Widget\BrandList
{
    public const CONFIG_VALUES_PATH = 'dsshopby_brand/general/brands_popup_config';

    /**
     * @var string
     */
    protected $_template = 'Dotsquares_ShopbyBrand::brands_popup.phtml';
