...
namespace Dotsquares\ShopbyBrand\Model\Customizer\Category;
...
class Brand implements CustomizerInterface
{
    ...
    /**
     * @var \Dotsquares\ShopbyBrand\Helper\Content
     */
    ...
    public function __construct(
        \Dotsquares\ShopbyBrand\Helper\Content $brandContentHelper,
        \Magento\Catalog\Model\Layer\Resolver $layerResolver,
        \Magento\Framework\App\RequestInterface $request,
        \Dotsquares\ShopbyBase\Helper\OptionSetting $optionSettingHelper,
    ...
    {
        if ($description) {
            $description = '<span class="dsshopby-descr">' . join('<br>', $description) . '</span>';
