...
namespace Dotsquares\ShopbyBrand\Model\ResourceModel\Slider\Grid;

use Dotsquares\ShopbyBase\Helper\FilterSetting;
use Dotsquares\ShopbyBrand\Model\ConfigProvider;
use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\Search\AggregationInterface;
use Dotsquares\ShopbyBase\Model\ResourceModel\OptionSetting\Collection as BrandCollection;
...
class Collection extends BrandCollection implements SearchResultInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getSelect()
            ->joinInner(
                ['dsshopbybrand_option' => $this->getTable('eav_attribute_option')],
                'main_table.value = dsshopbybrand_option.option_id',
                []
            )
            ->join(
    ...
    {
        $titleField = \Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface::TITLE;
        if ($field != $titleField) {
