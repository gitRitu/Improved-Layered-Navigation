...
use Dotsquares\ShopbyBase\Model\OptionSettingFactory;
...
use Dotsquares\ShopbyBrand\Model\Brand\BrandDataInterfaceFactory;
use Dotsquares\ShopbyBrand\Model\BrandSettingProvider;
use Dotsquares\ShopbyBrand\Model\ProductCount;
...
class LoadItems
{
    ...
    {
        return 'dotsquares_shopby_brand_items_collection-store' . $storeId;
    }
