...
namespace Dotsquares\ShopbyBrand\Model\UrlBuilder;
...
{
    public const SELF_ROUTE_PATH = 'dsbrand/index/index';
    public const SEO_BRAND_MODULES = ['dsshopby', 'cms'];
    public const MODULE_NAME = 'dsbrand';
