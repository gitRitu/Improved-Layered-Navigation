...
namespace Dotsquares\ShopbyBrand\Test\Unit\Controller\Adminhtml\Slider;

use Dotsquares\ShopbyBrand\Controller\Adminhtml\Slider\Edit;
...
class EditTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setup(): void
    {
        ...
        $this->settingHelper = $this->createMock(\Dotsquares\ShopbyBase\Helper\OptionSetting::class);
        $this->optionSetting = $this->createMock(\Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface::class);
    ...
    public function testLoadSettingModel()
    {
        ...
        $optionSetting = $this->getObjectManager()->getObject(\Dotsquares\ShopbyBase\Model\OptionSetting::class);
