...
define([
    ...
    $.widget('ds.brandsSearch', {
        options: {
            brands: null
        },
        selectors: {
            input: '[data-dsbrands-js="input"]',
            livesearch: '[data-dsbrands-js="livesearch"]',
            clearButton: '[data-dsbrands-js="clear"]'
        },
        classes: {
            active: '-active'
        },
        nodes: {
            resultItem: '<a class="dsbrands-item" href="{url}">{content}</a>'
        },
