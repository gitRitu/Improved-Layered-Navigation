...
namespace Dotsquares\Megamenu\Plugin\Utility;
...
class Utility
{
    ...
    /** @var  \Dotsquares\Megamenu\Model\License */
     ...
     * @param \Dotsquares\Megamenu\Model\License $licenseModel
     */
    public function __construct(
        \Magento\Backend\Model\Auth $auth,
        \Magento\Framework\App\ResponseInterface $response,
        \Magento\Framework\App\ViewInterface $view
        // \Dotsquares\Megamenu\Model\License $licenseModel
    )
    {
        $this->_auth = $auth;
    ...
    )
    {
        ...
        if ($this->_auth->isLoggedIn() && !$request->isAjax() && $this->_isPathRestrictionRequired() && $request->isDispatched() && !$this->_isLcVd()) {
            ...
            $this->_view->loadLayout(['default', 'dotsquares_license_needed'], true, true, false);
