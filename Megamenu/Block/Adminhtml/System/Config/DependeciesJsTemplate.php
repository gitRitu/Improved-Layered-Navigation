...
class DependeciesJsTemplate extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Dotsquares_Megamenu::system/config/dependencies_js.phtml';
    ...
    public function mmImageUploadOptionsAllowed()
    {
        ...
        $parentCategoryMegamenuImageEnabled = $currentCategory->getParentCategory()->getData('dotsquares_mm_image_enable');
