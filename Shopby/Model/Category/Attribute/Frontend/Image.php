...
namespace Dotsquares\Shopby\Model\Category\Attribute\Frontend;
...
class Image
{
    ...
    public function __construct(
        \Dotsquares\Shopby\Helper\Data $shopbyHelper,
        ...
        $placeholder = 'Dotsquares_Shopby::images/category/placeholder/placeholder.jpg'
    ) {
    ...
    protected function resizeAndGetUrl($imageUrl, $width = null, $height = null)
    {
        ...
        try {
            ...
            $this->logger->error("Dotsquares Shopby: Resize Image Error: " . $e->getMessage());
        }
        return $resultUrl;
    }
