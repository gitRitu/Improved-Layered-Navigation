...
class ConfigProvider extends \Dotsquares\Base\Model\ConfigProviderAbstract
{
    ...
    public const IS_NEW_FILTER_ENABLED = 'ds_is_new_filter/enabled';
    public const ON_SALE_FILTER_ENABLED = 'ds_on_sale_filter/enabled';
    public const EXCLUDE_OUT_OF_STOCK = 'general/exclude_out_of_stock';
    public const BRAND_ATTRIBUTE_CODE = 'dsshopby_brand/general/attribute_code';
    ...
    {
        return $this->getValue('ds_is_new_filter');
    }

    public function getOnSaleConfig(): array
    {
        return $this->getValue('ds_on_sale_filter');
    }
