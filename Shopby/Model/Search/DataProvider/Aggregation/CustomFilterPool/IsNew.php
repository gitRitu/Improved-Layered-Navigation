...
use Dotsquares\Shopby\Model\Layer\Filter\IsNew\Helper as IsNewHelper;
...
class IsNew implements OperationInterface
{
    ...
    public function getAggregation(Table $entityIdsTable, array $dimensions = []): Select
    {
        ...
        $derivedTable->joinLeft(
            ['ds_is_new' => $collection->getSelect()],
            'ds_is_new.entity_id  = entities.entity_id',
            [
                'value' => new \Zend_Db_Expr("if(ds_is_new.entity_id is null, 0, 1)")
            ]
        );
