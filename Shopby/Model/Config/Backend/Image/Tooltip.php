...
namespace Dotsquares\Shopby\Model\Config\Backend\Image;
...
class Tooltip extends \Magento\Config\Model\Config\Backend\Image
{
     ...
     *
     */
    public const UPLOAD_DIR = 'dotsquares/shopby/images';

    public const DEFAULT_VALUE = 'dotsquares/shopby/images/tooltip.png';
    ...
    public function beforeSave()
    {
        ...
        if (!empty($file)) {
            ...
            if (is_array($value) && !empty($value['delete'])) {
                $this->deleteOldFile();
                $this->setValue('dotsquares/shopby/images/tooltip.png');
            } else {
                $this->unsValue();
            }
        }
    ...
    protected function deleteOldFile()
    {
        ...
        if ($this->getOldValue() != 'dotsquares/shopby/images/tooltip.png' && $this->fileDriver->isFile($absoluteOldPath)) {
