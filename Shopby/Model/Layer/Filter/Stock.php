...
class Stock extends AbstractFilter
{
    ...
    public function getName()
    {
        $label = $this->scopeConfig
            ->getValue('dsshopby/stock_filter/label', ScopeInterface::SCOPE_STORE);
        return $label;
    }
    ...
    public function getPosition()
    {
        $position = (int) $this->scopeConfig
            ->getValue('dsshopby/stock_filter/position', ScopeInterface::SCOPE_STORE);
        return $position;
    }
    ...
    private function isStockSourceQty()
    {
         $stockSource = $this->scopeConfig
            ->getValue('dsshopby/stock_filter/stock_source', ScopeInterface::SCOPE_STORE);
        return $stockSource === \Dotsquares\Shopby\Model\Source\StockFilterSource::QTY;
    }
