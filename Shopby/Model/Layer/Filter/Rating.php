...
class Rating extends AbstractFilter
{
    ...
    public function getName()
    {
        $label = $this->scopeConfig
            ->getValue('dsshopby/rating_filter/label', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        return $label;
    }
    ...
    public function getPosition()
    {
        $position = (int) $this->scopeConfig
            ->getValue('dsshopby/rating_filter/position', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        return $position;
    }
    ...
    private function getLabelHtml($countStars)
    {
        ...
        $block->setTemplate('Dotsquares_Shopby::layer/filter/item/rating.phtml');
