...
class IsNew extends \Magento\Catalog\Model\Layer\Filter\AbstractFilter
{
    ...
    public const FILTER_LABEL_XML_PATH = 'dsshopby/ds_is_new_filter/label';
    public const FILTER_POSITION_XML_PATH = 'dsshopby/ds_is_new_filter/position';
    public const ATTRIBUTE_CODE = 'ds_is_new';
