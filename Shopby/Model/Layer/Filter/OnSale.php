...
class OnSale extends \Magento\Catalog\Model\Layer\Filter\AbstractFilter
{
    ...
    public const ATTRIBUTE_CODE = 'ds_on_sale';
    ...
    public function getName()
    {
        $label = $this->scopeConfig
            ->getValue('dsshopby/ds_on_sale_filter/label', ScopeInterface::SCOPE_STORE);
        return $label;
    }
    ...
    public function getPosition()
    {
        $position = (int) $this->scopeConfig
            ->getValue('dsshopby/ds_on_sale_filter/position', ScopeInterface::SCOPE_STORE);
        return $position;
    }
