...
use Dotsquares\Shopby\Model\Layer\Filter\Resolver\FilterRequestDataResolver;
use Dotsquares\Shopby\Model\Layer\Filter\Resolver\FilterSettingResolver;
use Dotsquares\Shopby\Model\ResourceModel\Fulltext\Collection as ShopbyFulltextCollection;
...
use Dotsquares\Shopby\Helper\Category as CategoryHelper;
...
use Dotsquares\Shopby\Model\Layer\Filter\Item\CategoryExtendedDataBuilder;
...
class Category extends \Magento\Catalog\Model\Layer\Filter\AbstractFilter
{
    ...
    public const EXCLUDE_CATEGORY_FROM_FILTER = 'ds_exclude_from_filter';
    ...
    protected function _getItemsData()
    {
        ...
        if ($this->getSetting()->getSortOptionsBy() == \Dotsquares\Shopby\Model\Source\SortOptionsBy::NAME) {
