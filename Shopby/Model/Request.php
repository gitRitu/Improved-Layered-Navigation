...
class Request extends \Magento\Framework\DataObject
{
    ...
    private function getParams(FilterInterface $filter)
    {
        ...
        if ($filter->getRequestVar() == \Dotsquares\Shopby\Model\Source\DisplayMode::ATTRUBUTE_PRICE && $param) {
            $param = $this->getParam(Price::DS_BASE_PRICE) ?: $param;
        }
    ...
    {
        $bulkParams = $this->request->getParam('dsshopby', []);
