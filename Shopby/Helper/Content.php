...
use Dotsquares\Shopby\Model\Source\AbstractFilterDataPosition;
...
use Dotsquares\ShopbyPage\Model\Page as PageEntity;
...
{
    public const APPLY_TO_HEADING = 'ds_apply_to_heading';
    public const APPLY_TO_META = 'ds_apply_to_meta';
    ...
    /**
     * @var \Dotsquares\Shopby\Model\Layer\FilterList
     */
    private $filterList;
    ...
    /**
     * @var \Dotsquares\ShopbyBase\Helper\OptionSetting
     */
    ...
    public function __construct(
        ...
        \Dotsquares\Shopby\Model\Layer\FilterList $filterList,
        \Magento\Store\Model\StoreManager $storeManager,
        \Magento\Framework\Registry $registry,
        \Magento\Framework\View\Page\Config $pageConfig,
        \Dotsquares\ShopbyBase\Helper\OptionSetting $optionHelper,
    ...
    {
        $this->_settings['meta'] = $this->scopeConfig->getValue('dsshopby/meta', ScopeInterface::SCOPE_STORE);
        $this->_settings['heading'] = $this->scopeConfig->getValue('dsshopby/heading', ScopeInterface::SCOPE_STORE);
        ...
        $allAttributes = \Dotsquares\Shopby\Model\Source\Attribute\Extended::ALL;
     ...
     * @return \Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface[]
     */
    private function getAppliedOptionSettings()
    {
        if ($this->optionSettings === null) {
            ...
            foreach ($this->_helper->getSelectedFiltersSettings() as $row) {
                ...
                $values = explode(',', $this->dsshopbyRequest->getParam($filter->getRequestVar()));
                foreach ($values as $v) {
    ...
    /**
     * see Dotsquares\GroupedOptions\Plugin\Shopby\Helper\Content\AddGroupOptionData
     * @param string $value
     * @param string $filterCode
     * @param Attribute $attrModel
     *
     * @return \Dotsquares\ShopbyBase\Api\Data\OptionSettingInterface|\Dotsquares\ShopbyBase\Model\OptionSetting
     */
    ...
    private function setDescription($descriptions)
    {
        ...
        if ($descriptions && $position != AbstractFilterDataPosition::DO_NOT_ADD) {
            ...
            $description = '<span class="dsshopby-descr">' . join('<br>', $descriptions) . '</span>';
            switch ($position) {
