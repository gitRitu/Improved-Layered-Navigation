...
use Dotsquares\Shopby\Model\Layer\GetSelectedFiltersSettings;
use Dotsquares\Shopby\Model\Layer\IsBrandPage;
...
use Dotsquares\Shopby;
use Magento\Framework\App\ObjectManager;
use Magento\Framework\Registry;
use Magento\Store\Model\ScopeInterface;
use Dotsquares\ShopbyBase\Helper\OptionSetting as OptionSettingHelper;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Swatches\Helper\Data as SwatchesHelper;

class Data extends AbstractHelper
{
    public const UNFOLDED_OPTIONS_STATE = 'dsshopby/general/unfolded_options_state';

    /**
     * @deprecated setting moved to ConfigProvider
     * @see \Dotsquares\ShopbyBase\Model\ConfigProvider
     */
    public const DSSHOPBY_ROOT_GENERAL_URL_PATH = 'dsshopby_root/general/url';

    /**
     * @deprecated setting moved to ConfigProvider
     * @see \Dotsquares\ShopbyBase\Model\ConfigProvider
     */
    public const DSSHOPBY_ROOT_ENABLED_PATH = 'dsshopby_root/general/enabled';
    public const CATEGORY_FILTER_POSITION = 'dsshopby/category_filter/position';
    public const CATALOG_SEO_SUFFIX_PATH = 'catalog/seo/category_url_suffix';
    public const DSSHOPBY_INDEX_INDEX = 'dsshopby_index_index';
    ...
    {
        return $this->scopeConfig->isSetFlag('dsshopby/general/ajax_enabled', ScopeInterface::SCOPE_STORE)
            || $this->collectFilters();
    }
    ...
    public function getTooltipUrl()
    {
        ...
        $tooltipImage = $this->scopeConfig->getValue('dsshopby/tooltips/image', ScopeInterface::SCOPE_STORE);
    ...
    public function getAjaxCleanUrl($activeFilters)
    {
        ...
        return str_replace('&amp;', '&', $this->dsUrlBuilder->getUrl('*/*/*', $params));
    }
    ...
    public function getSubmitFiltersDesktop(): int
    {
        return (int) $this->scopeConfig->getValue(
            'dsshopby/general/submit_filters_on_desktop',
    ...
    {
        return (int) $this->scopeConfig->getValue(
            'dsshopby/general/submit_filters_on_mobile',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getAllProductsUrlKey()
    {
        return ObjectManager::getInstance()
            ->get(\Dotsquares\ShopbyBase\Model\ConfigProvider::class)
    ...
    {
        return ObjectManager::getInstance()
            ->get(\Dotsquares\ShopbyBase\Model\AllProductsConfig::class)
    ...
    public function isShopbyPageWithAjax()
    {
        return $this->getRequest()->getParam(self::SHOPBY_AJAX)
            && $this->getRequest()->getFullActionName() == self::DSSHOPBY_INDEX_INDEX;
    }
}
