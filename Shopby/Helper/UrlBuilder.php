...
use Dotsquares\Shopby\Model\Layer\Filter\Category as CategoryFilter;
use Dotsquares\ShopbyBase\Model\FilterSetting\IsMultiselect;
use Magento\Catalog\Model\Layer\Filter\FilterInterface;
use Magento\Framework\App\Helper\Context;
use Magento\Framework\Registry;
use Dotsquares\ShopbyBase\Helper\Data as BaseData;
...
class UrlBuilder extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function buildUrl(FilterInterface $filter, $optionValue)
    {
        ...
        return $this->dsUrlBuilder->getUrl($route, $params);
    }
    ...
    public function isSingleselectCategoryFilter($filter)
    {
        return $filter instanceof CategoryFilter
            ...
            && !in_array($this->_request->getFullActionName(), ['catalogsearch_result_index', 'dsbrand_index_index']);
    }
    ...
    protected function getCurrentValues()
    {
        ...
        if (empty($data)) {
            ...
            $data = isset($params['dsshopby'][$filterCode]) ? $params['dsshopby'][$filterCode] : null;
        }
