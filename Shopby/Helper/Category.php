...
use Dotsquares\ShopbyBase\Model\Category\Manager;
...
use Dotsquares\Shopby\Model\Category\Attribute\Frontend\Image as ImageModel;
use Dotsquares\Shopby\Plugin\Catalog\Model\Category as PluginCategory;

class Category extends \Magento\Framework\App\Helper\AbstractHelper
{
    public const ATTRIBUTE_CODE = 'category_ids';
    public const STORE_CODE = 'store_id';
    public const CHILDREN_CATEGORIES_SETTING_PATH = 'dsshopby/children_categories/';
    ...
    /**
     * @var \Dotsquares\ShopbyBase\Model\Category\Manager\Proxy
     */
