...
use Dotsquares\Base\Helper\Deploy as DeployHelper;
use Dotsquares\Shopby\Model\Config\Backend\Image\Tooltip;
...
class DeployPub implements DataPatchInterface, PatchRevertableInterface
{
    ...
    {
        $modulePath = $this->moduleDir->getDir('Dotsquares_Shopby');
        $modulePath .= '/pub';
