...
{
    public const FOLDER_INVALID = 'code/Dotsquares/Shopby/view/frontend/web/css/';
    public const FOLDER_REBUILD = 'app/code/Dotsquares/Shopby';
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        if (version_compare($this->magentoVersion->get(), '2.3.3', '<')) {
            throw new LocalizedException(
                __('Dotsquares Improved Layered Navigation supports Magento v.2.3.3+ only')
            );
        }
