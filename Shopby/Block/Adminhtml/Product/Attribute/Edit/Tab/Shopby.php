...
namespace Dotsquares\Shopby\Block\Adminhtml\Product\Attribute\Edit\Tab;

use Dotsquares\Shopby\Block\Adminhtml\Form\Renderer\Fieldset\MultiStore;
use Dotsquares\Shopby\Block\Adminhtml\Product\Attribute\Edit\Tab\Shopby\Multiselect;
...
use Dotsquares\Shopby\Model\Source\RenderCategoriesLevel;
use Dotsquares\Shopby\Model\Source\RenderCategoriesTree;
...
use Dotsquares\ShopbyBase\Block\Widget\Form\Element\Dependence;
...
use Dotsquares\Shopby\Model\Source\VisibleInCategory;
use Dotsquares\Shopby\Model\Source\Category as CategorySource;
use Dotsquares\Shopby\Model\Source\Attribute as AttributeSource;
use Dotsquares\Shopby\Model\Source\Attribute\Option as AttributeOptionSource;
use Dotsquares\Shopby\Model\Source\DisplayMode;
use Dotsquares\Shopby\Model\Source\MeasureUnit;
use Dotsquares\Shopby\Model\Source\MultipleValuesLogic;
use Dotsquares\Shopby\Model\Source\ShowProductQuantities;
use Dotsquares\Shopby\Model\Source\CategoryTreeDisplayMode;
use Dotsquares\Shopby\Model\Source\SortOptionsBy;
...
class Shopby extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    private function modifyFormData(Dependence $dependence, Form $form)
    {
        ...
        $this->_eventManager->dispatch(
            'dsshopby_attribute_form_tab_build_after',
    ...
    protected function addCategorySettingFields(
        ...
        $linkToGuide = 'https://amasty.com/docs/doku.php?id=magento_2:'
                    ...
                    . 'userguide_Dotsquares_Shopby#category_tree';
