...
use Dotsquares\ShopbyBase\Model\FilterSetting\IsApplyFlyOut;
...
{
    public const TOP_NAV_RENDERER_NAME = 'dsshopby.catalog.topnav.renderer';
    ...
    public function render(FilterInterface $filter)
    {
        ...
        if ($filter instanceof \Dotsquares\Shopby\Model\Layer\Filter\Category) {
        ...
        if ($this->filter instanceof \Dotsquares\Shopby\Api\Data\FromToFilterInterface) {
    ...
    protected function getCategoryTreeHtml(FilterInterface $filter)
    {
        return $this->getLayout()
            ->createBlock(\Dotsquares\Shopby\Block\Navigation\FilterRenderer\Category::class)
            ->setFilter($filter)
            ->render();
    }
    ...
    public function getTooltipHtml(FilterSettingInterface $setting): string
    {
        ...
        return $this->getLayout()->createBlock(\Dotsquares\Shopby\Block\Navigation\Widget\Tooltip::class)
     ...
     */
    public function checkedFilter(\Dotsquares\Shopby\Model\Layer\Filter\Item $filterItem)
    {
    ...
    {
        return $this->urlBuilder->buildUrl($this->filter, 'dsshopby_slider_from-dsshopby_slider_to');
    }
    ...
    public function getFromToWidget($type)
    {
        return $this->getLayout()->createBlock(
            \Dotsquares\Shopby\Block\Navigation\Widget\FromTo::class
        )
