...
namespace Dotsquares\Shopby\Block\Navigation\FilterRenderer;
...
class Category extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @return \Dotsquares\Shopby\Model\Layer\Filter\Category
     * @throws LocalizedException
     */
    public function getFilter()
    {
        if (!$this->getData('filter') instanceof \Dotsquares\Shopby\Model\Layer\Filter\Category) {
