...
use Dotsquares\ShopbyBase\Model\FilterSetting\StoreSettingResolver;
...
class Tooltip extends Template implements WidgetInterface, IdentityInterface
{
     ...
     * @var string
     */
    protected $_template = 'Dotsquares_Shopby::layer/widget/tooltip.phtml';
    ...
    {
        return sprintf(
            '<span class="tooltip dsshopby-filter-tooltip" title="{content}"><img src="%s"></span>',
