...
{
    public const VAR_REPLACE_URL = 'dotsquares_shopby_replace_url';
    ...
    public function __construct(
        ...
        \Dotsquares\ShopbyBase\Api\UrlBuilderInterface $urlBuilder,
        array $data = []
    ) {
    ...
    {
        return $this->getRequest()->getParam(\Dotsquares\Shopby\Block\Navigation\UrlModifier::VAR_REPLACE_URL) !== null;
    }
}
