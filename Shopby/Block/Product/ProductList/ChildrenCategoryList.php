...
namespace Dotsquares\Shopby\Block\Product\ProductList;

use Magento\Framework\View\Element\Template;
use Dotsquares\Shopby\Model\Source\ChildrenCategoriesBlock\Categories;
use Dotsquares\Shopby\Model\Source\ChildrenCategoriesBlock\DisplayMode;
...
class ChildrenCategoryList extends Template
{
    ...
    /**
     * @var \Dotsquares\Shopby\Helper\Category
     */
     ...
     * @param \Dotsquares\Shopby\Helper\Category $categoryHelper
     * @param array $data
     */
    public function __construct(
        Template\Context $context,
        \Magento\Framework\Registry $coreRegistry,
        \Dotsquares\Shopby\Helper\Category $categoryHelper,
