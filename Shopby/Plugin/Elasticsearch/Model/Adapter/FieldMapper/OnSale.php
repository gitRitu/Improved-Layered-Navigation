...
namespace Dotsquares\Shopby\Plugin\Elasticsearch\Model\Adapter\FieldMapper;

use Dotsquares\Shopby\Plugin\Elasticsearch\Model\Adapter\AdditionalFieldMapperInterface;

class OnSale implements AdditionalFieldMapperInterface
{
    public const ATTRIBUTE_NAME = 'ds_on_sale';
