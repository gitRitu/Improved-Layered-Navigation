...
{
    public const FIELD_NAME = 'ds_is_new';
    ...
    /**
     * @var \Dotsquares\Shopby\Model\Layer\Filter\IsNew\Helper
     */
    private $isNewHelper;
    ...
    public function __construct(
        ...
        \Dotsquares\Shopby\Model\Layer\Filter\IsNew\Helper $isNewHelper,
    ...
    public function isAllowed(): bool
    {
        return $this->scopeConfig->isSetFlag(
            'dsshopby/ds_is_new_filter/enabled',
