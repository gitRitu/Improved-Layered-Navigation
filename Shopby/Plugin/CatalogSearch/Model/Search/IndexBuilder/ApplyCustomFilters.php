...
namespace Dotsquares\Shopby\Plugin\CatalogSearch\Model\Search\IndexBuilder;

use Dotsquares\Shopby\Model\Layer\Cms\Manager as CmsManager;
use Dotsquares\Shopby\Model\ConfigProvider;
use Dotsquares\Shopby\Model\Request;
use Dotsquares\Shopby\Model\ResourceModel\Search\FilterMapper\CustomExclusionStrategyPool;
use Dotsquares\Shopby\Model\ResourceModel\Search\IndexBuilder as IndexBuilderResource;
use Dotsquares\Shopby\Model\Source\StockFilterSource;
use Dotsquares\Shopby\Plugin\CatalogSearch\Model\Search\FilterMapper\CustomExclusionStrategy;
