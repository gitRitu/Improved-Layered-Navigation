...
namespace Dotsquares\Shopby\Plugin\Framework\Url;
...
{
    /**
     * @var \Dotsquares\Shopby\Model\Resolver
     */
    protected $dsResolver;
     ...
     * @param \Dotsquares\Shopby\Model\Resolver $dsResolver
     * @param \Magento\Framework\Url\QueryParamsResolverInterface $queryParamsResolver
     * @param \Dotsquares\Shopby\Model\Request $shopbyRequest
     * @param ScopeConfigInterface $scopeConfig
    * @param Content $contentHelper
     */
    public function __construct(
        \Magento\Catalog\Model\Layer\Resolver $layerResolver,
        \Dotsquares\Shopby\Model\Resolver $dsResolver,
        \Magento\Framework\Url\QueryParamsResolverInterface $queryParamsResolver,
        \Dotsquares\Shopby\Model\Request $shopbyRequest,
    ...
    public function aroundSetRouteParams(
        ...
        $queryParams[\Dotsquares\Shopby\Block\Navigation\UrlModifier::VAR_REPLACE_URL] = null;
        $queryParams['dsshopby'] = null;
    ...
    {
        if (!$this->layer) {
            $this->layer = $this->dsResolver->loadFromParent($this->layerResolver)->get();
        }
