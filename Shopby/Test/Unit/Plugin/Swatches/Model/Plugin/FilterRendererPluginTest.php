...
namespace Dotsquares\Shopby\Test\Unit\Plugin\Swatches\Model\Plugin;

use Dotsquares\Shopby\Model\Source\DisplayMode;
use Dotsquares\Shopby\Test\Unit\Traits;
use Dotsquares\Shopby\Plugin\Swatches\Model\Plugin\FilterRendererPlugin;
use Dotsquares\Shopby\Helper\FilterSetting;
use Magento\LayeredNavigation\Block\Navigation\FilterRenderer;
use Magento\Swatches\Model\Swatch;
use Dotsquares\ShopbyBase\Model\FilterSetting as SettingsModel;
use Dotsquares\Shopby\Model\Layer\Filter\Attribute as DotsquaresAttribute;
...
class FilterRendererPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBeforeAroundRender($addAttribute, $displayMode, $result)
    {
        ...
        $filter = $this->getObjectManager()->getObject(DotsquaresAttribute::class, []);
        if ($addAttribute) {
