...
class FilterListTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setup(): void
    {
        ...
        $config = $this->createMock(\Dotsquares\Shopby\Helper\Config::class);
    ...
    {
        $categoryFilter = $this->createMock(\Dotsquares\Shopby\Model\Layer\Filter\Category::class);
        $ratingFilter = $this->createMock(\Dotsquares\Shopby\Model\Layer\Filter\Rating::class);
