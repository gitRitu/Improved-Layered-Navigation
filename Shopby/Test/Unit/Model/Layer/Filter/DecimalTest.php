...
namespace Dotsquares\Shopby\Test\Unit\Model\Layer\Filter;
...
class DecimalTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var MockObject|\Dotsquares\Shopby\Model\ResourceModel\Fulltext\Collection
     */
    ...
    public function setup(): void
    {
        ...
        $this->productCollection = $this->createMock(\Dotsquares\Shopby\Model\ResourceModel\Fulltext\Collection::class);
    ...
    public function testGetRangeForState()
    {
        ...
        $settingFilter->setDisplayMode(\Dotsquares\Shopby\Model\Source\DisplayMode::MODE_SLIDER);
        $this->assertEquals(
            '10.00$ - 20.00$',
            (string)$this->invokeMethod($this->model, 'getRangeLabel', [10.0, 20.0])
        );

        $settingFilter->setDisplayMode(\Dotsquares\Shopby\Model\Source\DisplayMode::MODE_FROM_TO_ONLY);
        $this->assertEquals(
            '10.00$ - 20.00$',
            (string)$this->invokeMethod($this->model, 'getRangeLabel', [10.0, 20.0])
        );
