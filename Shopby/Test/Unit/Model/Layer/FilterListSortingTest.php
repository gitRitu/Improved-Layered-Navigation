...
namespace Dotsquares\Shopby\Test\Unit\Model\Layer;
...
class FilterListSortingTest extends TestCase
{
    ...
    public function sortingByPositionProvider()
    {
        ...
        return [
            'Sidebar Sorting' => [
                ...
                \Dotsquares\Shopby\Model\Layer\FilterList::PLACE_SIDEBAR
            ],
            'Top Sorting' => [
                [$item4top2, $item5top4, $item1, $item2top5, $item3],
                [$item1, $item4top2, $item3, $item5top4, $item2top5],
                \Dotsquares\Shopby\Model\Layer\FilterList::PLACE_TOP
            ]
        ];
    }
    ...
    {
        $filter = $this->getMockBuilder(\Dotsquares\Shopby\Model\Layer\Filter\OnSale::class)
        ...
        $settings = $this->createMock(\Dotsquares\ShopbyBase\Model\FilterSetting::class);
