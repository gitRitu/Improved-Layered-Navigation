...
], function (_, $, ko, dsShopbyTopFilters) {
    'use strict';
    $.widget('mage.dsShopbyAjax', {
        prevCall: false,
        $shopbyOverlay: null,
        cached: [],
        memorizeData: [],
        ...
        filterTooltip: '.dsshopby-filter-tooltip',
        response: null,
        cacheKey: null,
        startAjax: false,
        isCategorySingleSelect: 0,
        nodes: {
            loader: $('<div id="dotsquares-shopby-overlay" class="dsshopby-overlay-block">' +
                '<span class="dsshopby-loader"></span></div>')
        },
        selectors: {
            products_wrapper: '#dotsquares-shopby-product-list, .search.results',
            top_nav: '.dotsquares-catalog-topnav',
            products: '.products.wrapper',
            overlay: '#dotsquares-shopby-overlay',
            top_navigation: '.catalog-topnav .block.filter',
            js_init: '[data-ds-js="js-init"]',
        ...
        initWidget: function () {
            ...
            $(document).on('dsshopby:submit_filters', function (event, eventData) {
                ...
                $.mage.dsShopbyAjax.prototype.cacheKey = cacheKey;
                if (self.cached[cacheKey]) {
                    ...
                    if (pushState || isSorting) {
                        ...
                        self.initAjax();
                    } else if ($.mage.dsShopbyApplyFilters) {
                        $.mage.dsShopbyApplyFilters.prototype.showButtonCounter(
            ...
            $(document).on('dsshopby:reload_html', function (event, eventData) {
        ...
        callAjax: function (clearUrl, data, pushState, cacheKey, isSorting) {
            ...
            $.mage.dsShopbyAjax.prototype.startAjax = true;
            ...
            return $.ajax({
                ...
                success: function (response) {
                    try {
                        $.mage.dsShopbyAjax.prototype.startAjax = false;
                        ...
                        $.mage.dsShopbyAjax.prototype.response = response;
                        if (response.newClearUrl
                            && (response.newClearUrl.indexOf('?p=') == -1 && response.newClearUrl.indexOf('&p=') == -1)) {
                            self.options.clearUrl = response.newClearUrl;
                        }

                        if (pushState || ($.mage.dsShopbyApplyFilters && $.mage.dsShopbyApplyFilters.prototype.showButtonClick) || isSorting) {
                            window.history.pushState({url: response.url}, '', response.url);
                        }
                        ...
                        if ($.mage.dsShopbyApplyFilters && $.mage.dsShopbyApplyFilters.prototype.showButtonClick) {
                        ...
                        if ($.mage.dsShopbyApplyFilters) {
                            $.mage.dsShopbyApplyFilters.prototype.showButtonCounter(response.productsCount);
                        }

                        $(document).trigger('dsshopby:ajax_filter_applied');
                    } catch (e) {
        ...
        reloadHtml: function (data) {
            var selectSidebarNavigation = '.sidebar.sidebar-main .block.filter',
                selectTopNavigation = selectSidebarNavigation + '.dsshopby-all-top-filters-append-left',
            ...
            $('.ds_shopby_apply_filters').remove();
            ...
            if (!data.categoryProducts || data.categoryProducts.indexOf('dotsquares-catalog-topnav') == -1) {
            ...
            mediaCheck({
                ...
                entry: function () {
                    ...
                    if (selectMainNavigation == selectTopNavigation
                        && $(selectSidebarNavigation + ':not(.dsshopby-all-top-filters-append-left)').length != 0) {
            ...
            $('.dsshopby-filters-bottom-cms').remove();
        ...
        afterChangeContentExternal: function (productList) {
            //compatibility with Dotsquares Scroll extension
            $(document).trigger('dsscroll_refresh');
        ...
        initAjax: function () {
            ...
            if ($.mage.productListToolbarForm) {
                ...
                $.mage.productListToolbarForm.prototype.changeUrl = function (paramName, paramValue, defaultValue) {
                    ...
                    //add ajax call
                    $.mage.dsShopbyFilterAbstract.prototype.prepareTriggerAjax(null, null, null, true);
                };
            }
            ...
            $(".toolbar .pages a").unbind('click').bind('click', function (e) {
                ...
                $.mage.dsShopbyFilterAbstract.prototype.prepareTriggerAjax(document, updatedUrl, false, true);
