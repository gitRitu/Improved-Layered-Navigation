    ...
    return {
        moveTopFiltersToSidebar: function () {
            if ($('.sidebar.sidebar-main #narrow-by-list').length === 0) {
                ...
                $element
                    .addClass('dsshopby-all-top-filters-append-left')
            ...
            $(".catalog-topnav #narrow-by-list .filter-options-item").each(function () {
                ...
                if (classes) {
                    ...
                    for (var i = 0; i < listClasses.length; i++) {
                        if (listClasses[i].indexOf('ds-filter-items-') !== -1) {
                ...
                $('.sidebar.sidebar-main #narrow-by-list').first().append(
                    $(this).clone().addClass('dsshopby-filter-top')
                );
            });
        ...
        removeTopFiltersFromSidebar: function () {
            ...
            $('.sidebar.sidebar-main #narrow-by-list .dsshopby-filter-top').remove();
            $('.sidebar.sidebar-main .dsshopby-all-top-filters-append-left').remove();
        }
    };
});
