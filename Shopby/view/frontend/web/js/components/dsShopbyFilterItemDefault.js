define([
    ...
    $.widget('mage.dsShopbyFilterItemDefault', $.mage.dsShopbyFilterAbstract, {
        options: {},
        selectors: {
            parent: '.item',
            checkbox: 'input[type=checkbox], input[type=radio]',
            nameCategory: '[name="dsshopby[cat][]"]'
        },
        ...
        _create: function () {
            ...
            checkbox.on('dsshopby:sync_change', function (e) {
                self.markAsSelected($(this));
            });
        ...
        isFinderAndCategory: function (element) {
            return location.href.indexOf('find=') !== -1
                && element.type === 'radio'
                && element.name === 'dsshopby[cat][]';
        },
    });

    return $.mage.dsShopbyFilterItemDefault;
});
