...
define([
    ...
    $.widget('mage.dsShopbyFilterCollapse', {
        options: {
            mode: null,
        ...
        selectors: {
            collapseButton: '.ds-collapse-icon',
            filterParent: '.dsshopby-filter-parent',
            inputChecked: 'input[checked]',
            inputCat: 'input[name^="dsshopby[cat]"]',
            itemsList: '.items',
            categoryDropdown: '[data-dsshopby-js="category-dropdown"]',
            categoryDropdownElement: '[data-dsshopby-js="category-dropdown-{id}"]',
            filterItems: '[data-dsshopby-js="filter-items-{code}"]'
        },
        classes: {
            active: '-active'
        },
    ...
    return $.mage.dsShopbyFilterCollapse;
});
