/**
 *  Dotsquares Filter Category Component
 */
...
define([
    ...
    $.widget('mage.dsShopbyFilterCategory', $.mage.dsShopbyFilterAbstract, {
        options: {
            type: null,
            collectFilters: null,
            clearUrl: null
        ...
        initEventListeners: function () {
            ...
            checkbox.on('dsshopby:sync_change', function () {
                self.markAsSelected($(this));
            });
        },
    ...
    return $.mage.dsShopbyFilterCategory;
});
