...
namespace Dotsquares\Base\Block\Adminhtml\System\Config;
...
class Information extends Fieldset
{
    ...
    private function getInnerHtml(string $moduleCode, AbstractElement $element): string
    {
        ...
        $layout->getUpdate()->load(
            [
                'dotsquares_base_information_block',
        ...
        $basicBlock = $layout->getBlock('dsinfotab.basic');
        if ($basicBlock) {
