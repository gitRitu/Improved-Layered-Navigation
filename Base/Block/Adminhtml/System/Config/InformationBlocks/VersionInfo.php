...
class VersionInfo extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Dotsquares_Base::config/information/version_info.phtml';
    ...
    public function getLogoHref(): string
    {
        ...
        if ($this->moduleInfoProvider->isOriginMarketplace()) {
            ...
            $href = 'https://www.dotsquares.com/' . Information::SEO_PARAMS . 'dotsquares_logo_' . $moduleCode;
        }
    ...
    {
        return $this->assetRepo->getUrl('Dotsquares_Base::images/amasty_logo.svg');
    }
