...
use Dotsquares\Base\Debug\VarDump;
...
class Beautifier
{
    ...
    {
        VarDump::dotsquaresEcho(Template::$debugJsCss);
    }
    ...
    public function beautify($var)
    {
        ...
        VarDump::dotsquaresEcho(sprintf(Template::$varWrapper, $result));
    }
