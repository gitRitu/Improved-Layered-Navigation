...
/**
 * For Remote Debug
 * Output is going to file dotsquares_debug.log
 * @codeCoverageIgnore
...
class Log
{
     ...
     * @var string
     */
    private static $fileToLog = 'dotsquares_debug.log';
...
%message%
----------------------------------------------------------------------------\n\n";
        $formatter = new System\DotsquaresFormatter($output);

        $handler->setFormatter($formatter);
        self::$loggerInstance = new \Magento\Framework\Logger\Monolog('dotsquares_logger', [$handler]);
    }
}
