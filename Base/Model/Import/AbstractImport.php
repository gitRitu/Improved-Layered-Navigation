...
namespace Dotsquares\Base\Model\Import;

use Dotsquares\Base\Model\Import\Behavior\BehaviorProviderInterface;
use Dotsquares\Base\Model\Import\Mapping\MappingInterface;
use Dotsquares\Base\Model\Import\Validation\EncodingValidator;
...
abstract class AbstractImport extends AbstractEntity
{
    ...
    public const RUNTIME_ERRORS = 'ds_runtime_errors';
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\Dotsquares\Base\Exceptions\StopValidation $exception) {
