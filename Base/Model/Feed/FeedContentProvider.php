...
use Dotsquares\Base\Model\Feed\Response\FeedResponseInterface;
use Dotsquares\Base\Model\Feed\Response\FeedResponseInterfaceFactory;
...
class FeedContentProvider
{
    ...
    public function getFeedResponse(string $url, array $options = []): FeedResponseInterface
    {
        ...
        $curlObject->setConfig(
            [
                'timeout' => 2,
                'useragent' => 'Dotsquares Base Feed'
            ]
        );
        $headers = [];
