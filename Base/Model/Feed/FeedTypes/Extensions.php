...
class Extensions
{
    public const EXTENSIONS_CACHE_ID = 'dsbase_extensions';
    public const DOTSQUARES_EXTENSIONS_LAST_MODIFIED_DATE = 'dotsquares_extensions_last_modified_date';
    ...
    {
        return $this->cache->load(self::DOTSQUARES_EXTENSIONS_LAST_MODIFIED_DATE);
    }
    ...
    private function setLastModified()
    {
        ...
        return $this->cache->save($dateTime, self::DOTSQUARES_EXTENSIONS_LAST_MODIFIED_DATE);
    }
