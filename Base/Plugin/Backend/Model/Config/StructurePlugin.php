...
namespace Dotsquares\Base\Plugin\Backend\Model\Config;

use Dotsquares\Base\Block\Adminhtml\System\Config\Advertise;
use Dotsquares\Base\Model\Feed\AdsProvider;
use Dotsquares\Base\Model\Config;
use Dotsquares\Base\Model\LinkValidator;
...
class StructurePlugin
{
     ...
     */
    public const DOTSQUARES_ADVERTISE = [
        'dotsquares_advertise' => [
                'id' => 'dotsquares_base_advertise',
                'type' => 'text',
                'label' => 'Dotsquares Base Advertise',
                'children' => [
                    'label' => [
                        'id' => 'label',
                        'label' => '',
     ...
     * Tab name
     */
    public const DOTSQUARES_TAB_NAME = 'dotsquares';
    ...
    public function afterGetElementByPathParts(
        ...
        if (isset($moduleSection['tab']) && $moduleSection['tab'] === self::DOTSQUARES_TAB_NAME) {
    ...
    {
        $advertiseSection = self::DOTSQUARES_ADVERTISE;
        ...
        $advertiseSection['dotsquares_advertise']['data'] = $displayedAdvertise;

        if (isset($displayedAdvertise['tab_name'])) {
            $advertiseSection['dotsquares_advertise']['label'] = strip_tags($displayedAdvertise['tab_name']);
