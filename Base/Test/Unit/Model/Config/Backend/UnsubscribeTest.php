...
namespace Dotsquares\Base\Test\Unit\Model\Config\Backend;

use Dotsquares\Base\Model\Config\Backend\Unsubscribe;
...
class UnsubscribeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPrepareMessage()
    {
        ...
        $messageManager = $this->createMock(\Dotsquares\Base\Model\AdminNotification\Messages::class);
