...
namespace Dotsquares\Base\Controller\Adminhtml\Notification;
...
{
    /**
     * @var \Dotsquares\Base\Model\Config
     */
    private $config;

    /**
     * @var \Dotsquares\Base\Model\Source\Frequency
     */
    private $frequency;

    public function __construct(
        Action\Context $context,
        \Dotsquares\Base\Model\Config $config,
        \Dotsquares\Base\Model\Source\Frequency $frequency
    ) {
